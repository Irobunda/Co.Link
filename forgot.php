...
{   
    ...
    {   $_SESSION['message'] = "If that email address is in our database, 
        ...
        $message = "
	            ...
	            In order to reset your password, please click 
	            <a href='
	            http://localhost/projectspw/reset.php?email=$email&token=$token
	            '>here</a>to carry out the reset.<br><br>
	            If you did not initiate this reset,please contact nci.projectemail@gmail.com
	            
	            Kind Regards,<br>
	            Co.Link Support Team
	        ";
