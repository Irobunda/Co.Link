			...
			<section class="banner-area relative" id="home">
				...
				<div class="container">
					...
					<?php if(isset($_SESSION["loggedin"]) === true) : ?> 
						...
						<?php endif ?><br><br><br>
					    	<h3 class="text" style="font-size:35px;color:white">Co.Link Transport and Tours</h3>
							<h1 class="text"><a href="how_to.php" style="color: #8ceb50">HOW TO RIDE</a></h1>
							<p class="text" style="font-size:20px;color:white">see our <a href='routes.php'style="font-size:30px; color:red">routes</a></p>
						</div>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-5 about-left">
							<img class="img-fluid" src="img/about-img.jpg" alt="efficient travel">
						</div>					
						...
						<h4>Co.Link Transport is an municipal transport service provider that
						 ...
						 <h4><p> We aim to provide and promote inter-city public transportation choices 
							...
							community. </p></h4>
							<a class="text-uppercase primary-btn" href="banner.php">Reserve Your Seat </a>
						</div>
					</div>
				</div>	
			</section>		
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-4 single-service">
							...
							<a href="banner.php"><h4>Online Bookings</h4></a>
							<p>
						...
						<div class="col-lg-4 single-service">
							...
							<a href="deliver.php"><h4> Deliveries</h4></a>
							<p>
